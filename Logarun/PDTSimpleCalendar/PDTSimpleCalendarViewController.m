...
- (NSDate *)lastDate
{
    if (!_lastDate) {
        ...
        NSDateComponents *currentMonthComponent = [self.calendar components:NSCalendarUnitMonth|NSCalendarUnitYear
                                                        fromDate:[NSDate date]];
        currentMonthComponent.day = 1;
        NSDate *firstOfCurrentMonth = [self.calendar dateFromComponents:currentMonthComponent];
        
        [self setLastDate:[self.calendar dateByAddingComponents:offsetComponents toDate:firstOfCurrentMonth options:0]];
    }
...
-(void)viewDidAppear:(BOOL)animated {
    // edit made by andrew burford
    if (firstLoad) [self scrollToDate:[NSDate date] animated:YES];
    firstLoad = false;
}
...
- (void)viewDidLoad
{
    ...
    // edit made by andrew burford
    // sets background color to tan and circle color to light green
    
    self.backgroundColor = [UIColor colorWithRed:0.99 green:1.00 blue:0.84 alpha:1.0];
    [[PDTSimpleCalendarViewCell appearance] setCircleDefaultColor:[UIColor colorWithRed:0.90 green:0.93 blue:0.78 alpha:1.0]];
    /* experimental dark theme:
    self.backgroundColor = [UIColor colorWithRed:0.15 green:0.15 blue:0.15 alpha:1.0];
    [[PDTSimpleCalendarViewCell appearance] setCircleDefaultColor:[UIColor colorWithRed:0.20 green:0.20 blue:0.20 alpha:1.0]];
    */
