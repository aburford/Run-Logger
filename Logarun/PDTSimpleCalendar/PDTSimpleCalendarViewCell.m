...
CGFloat PDTSimpleCalendarCircleSize = 40.0f;
...
- (UIColor *)circleSelectedColor
{
    ...
    // sets selected circle color to dark green
    return [UIColor colorWithRed:0.89 green:0.74 blue:0.00 alpha:1.0];
}
...
- (UIColor *)textDisabledColor
{
    ...
    //return [UIColor lightGrayColor]; EDIT MADE BY ANDREW BURFORD
    return [UIColor blackColor];
}
